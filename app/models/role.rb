...
class Role < ApplicationRecord
  ...
  store_attribute :permissions, :create_blocked_dates, :boolean, default: false
  ...
  store_attribute :permissions, :delete_blocked_dates, :boolean, default: false
  ...
  store_attribute :permissions, :read_blocked_dates, :boolean, default: false
