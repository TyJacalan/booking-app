class Role < ApplicationRecord
  ...
  store_accessor :permission, :create_services, :read_services, :update_services, :delete_services
  store_accessor :permission, :create_appointments, :read_appointments, :update_appointments, :delete_appointments
